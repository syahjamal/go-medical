...
func InitDB() {
	...
	DB.AutoMigrate(&models.User{}, &models.Token{}, &models.Pasien{}, &models.Dokter{}, &models.Jadwal{}, &models.Booking{}, &models.Pemeriksaan{})

	DB.Model(&models.User{}).Related(&models.Pasien{})
}
